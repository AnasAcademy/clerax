    ...
    <div class="login-container justify-content-center align-items-center">
        ...
        <div class="login-card">
            ...
            <form method="post" action="/register" class="mt-35">
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label font-14" for="term">{{ trans('auth.i_agree_with') }}
                        <a href="pages/terms" target="_blank"
                            class="text-orange font-weight-bold font-14">{{ trans('auth.terms_and_rules') }}</a>
                    </label>
                ...
                <button type="submit" class="btn new-btn btn-block mt-20 py-10">{{ trans('auth.signup') }}</button>
            </form>
