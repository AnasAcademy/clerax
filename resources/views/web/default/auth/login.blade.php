    ...
    <div class="login-container justify-content-center align-items-center ">
        <div class="login-card">
            ...
            <form method="Post" action="/login" class="mt-35">
                ...
                <button type="submit" class="btn new-btn btn-block mt-20 py-10">{{ trans('auth.login') }}</button>
            </form>
            ...
            <div class="d-flex align-items-center mt-20 p-15 danger-transparent-alert ">
                ...
                <div class="ml-10">
                    <div class="font-14 font-weight-bold ">{{ session()->get('login_failed_active_session')['title'] }}
                    </div>
            ...
            <div class="text-center mt-20">
                <span
                    class="badge badge-circle-gray300 text-orange d-inline-flex align-items-center justify-content-center">{{ trans('auth.or') }}</span>
            </div>
            ...
            <div class="mt-30 text-center">
                <a href="/forget-password" class=" text-orange" target="_blank">{{ trans('auth.forget_your_password') }}</a>
            </div>

            <div class="mt-20 text-center">
                <span>{{ trans('auth.dont_have_account') }}</span>
                <a href="/register" class="text-orange font-weight-bold">{{ trans('auth.signup') }}</a>
            </div>
        </div>
    </div>
</div>
