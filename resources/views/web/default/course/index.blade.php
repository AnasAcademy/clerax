...
@section('content')
    <section class="course-cover-container {{ empty($activeSpecialOffer) ? 'not-active-special-offer' : '' }}">
        <img src="{{ asset('store/new/hero-placeholder.png') }}" class="h-100" alt="{{ $course->title }}" />
...
{{-- 
                        ...
                        @endif --}}
                         <div class="d-flex flex-row align-items-end gap-1 mt-20"> 
                            <img src=" {{ asset('store/new/cleraxLogo.png') }}" width="15%"/>
                            <p class="mr-2">يُقدَّم هذا البرنامج من قبل جوجل كورس ، وهي شريك لـ كليرا-اكس.</p>
                         </div>
