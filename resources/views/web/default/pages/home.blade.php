...
@else
    ...
    @endif -->
                            <div class="position-relative img-fluid text-center" style="width: 100%; height: auto;">
                                ...
                                <img src="{{ asset('store/new/hero.png') }}"
                                    alt="{{ $heroSectionData['title'] ?? 'hero' }}" width="70%" />
                            </div>
    ...
    <section class="home-sections home-sections-swiper container">
        ...
        @foreach ($structuredCategories as $cat)
            <div class="bg-light-gray p-20 structured-category-content {{ !$loop->first ? 'd-none' : '' }}"
                id="structured-cat-{{ $cat->id }}">

                @if ($cat->subCategories->count())
                    <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-2">
                        @foreach ($cat->subCategories->take(4) as $sub)
                            <button class="structured-sub-tab p-2 m-1 font-12  {{ $loop->first ? 'active' : '' }}"
                    ...
                    <div class="subcategory-content {{ !$loop->parent->first || !$loop->first ? 'd-none' : '' }}"
                        ...
                        <div class="row p-4">
                            @foreach ($sub->webinars->take(3) as $product)
                                <a href="{{ $product->getUrl() }}" class="col-12 col-sm-6 col-lg-3  mb-4 ">
                                    <div class="product-card h-100 d-flex flex-column">
                                            ...
                                            <figcaption
                                                ...
                                                <div>
                                                    ...
                                                    <div class="align-items-center d-flex flex-row justify-content-start">
                                                        ...
                                                        <span
                                                            class="text-gray text-right font-12">{{ $organization->full_name ?? 'none' }}
                                                        </span>
                                                    </div>
                                        ...
                                        @endif
                                                    ...
                                                    <div
                                                        class="d-flex flex-row justify-content-start gap-1 align-items-center">
                                                        {{-- <a type="submit" class="btn new-btn  w-50 p-1 font-12"
                                            href="/login">
                                            {{ trans('home.Enrol') }}
                                        </a> --}}
                        ...
                        @if ($sub->webinars->count() > 4)
                            <div class="text-center mt-3">
                                <a href="{{ $cat->getUrl() }}" class="btn btn-outline-primary  px-4 py-2">
                ...
                <div class="text-center text-md-right">
                    <a href="{{ $cat->getUrl() }}" class="btn new-btn  px-4 py-10">
    ...
    <div class="slider-container2 bg-light-gray mt-80 ">
            ...
            <div class="bg-light-gray p-20 popular-category-content {{ !$firstVisible ? '' : 'd-none' }}"
                ...
                <div class="row p-4 align-items-center justify-content-start">
                    ...
                    @foreach ($features->filter(fn($f) => $f->webinar) as $feature)
                        ...
                        <a href="{{ url('/course/' . $webinar->slug) }} " class="col-12 col-sm-6 col-lg-3 mt-20">
    ...
    <section class="home-sections home-sections-swiper container">
        <div class="row align-items-center p-5 rounded-3 mt-5">
            ...
            <div class="col-12 col-md-6 mb-4 mb-md-0 p-20 p-md-50 bg-light-gray rounded">
                <img id="testimonialImage" src="{{ asset('store/new/testimonial.png') }}" alt="testimonial"
                    class="w-100">
            </div>
        </div>
    </section>
    ...
    <section class="home-sections home-sections-swiper container">
        ...
        @foreach ($latestsubCategories as $subcategory)
            @if ($subcategory->webinars->count())
                <div class="bg-light-gray p-20 latest-category-content {{ !$firstVisible ? '' : 'd-none' }}"
...
@else
                ...
                <div class="container">
                    ...
                    <div
                        ...
                        <div class="col-12 col-md-5 text-center">
                            <img src="{{ asset('store/new/middle-section.png') }}" alt="img"
                                class="last-section-img">
                        </div>
    ...
    <a href="{{ $instructor->getProfileUrl() }}?tab=appointments"
                                            class="btn btn-primary btn-sm  mt-15">{{ trans('home.reserve_a_live_class') }}</a>
@else
    <a href="{{ $instructor->getProfileUrl() }}"
                                            class="btn btn-primary btn-sm  mt-15">{{ trans('public.profile') }}</a>
    @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            @foreach ($steps as $index => $step)
                                <div class="step-card p-3 rounded cursor-pointer {{ $loop->first ? 'active' : '' }}"
                                    ...
                                    <div class="d-flex justify-content-start mb-2 gap-3">
                                        <img src="{{ $step['icon'] }}" alt="icon" class="ms-2" width="30"
                                            height="30">
                    ...
                    <div class="col-md-6  mb-4 mb-md-0">
                        @foreach ($steps as $index => $step)
                            <img src="{{ $step['image'] }}" alt="Step {{ $index + 1 }}"
                                class="step-image img-fluid {{ $loop->first ? '' : 'd-none' }}"
                                data-image="{{ $step['id'] }}">
                        @endforeach
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div
                        ...
                        <div class="col-12 col-md-5 col-lg-4 d-flex-center">
                            <img src="{{ asset('store/new/last-section.png') }}" alt="img"
                                class="last-section-img">
                        </div>
                        ...
                        <div class="col-12 col-md-6  d-flex flex-column align-items-start ">
                            <h2 class="text-dark font-weight-bold font-30">
                                ...
                                <br>
                                <span class="text-orange">{{ trans('home.more-than-courses2') }}</span>
                            </h2>
                            <a type="submit" class="btn new-btn  mt-20 py-10" href="/login">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.structured-parent-tab').forEach(tab => {
                tab.addEventListener('click', () => {
                    ...
                    // Toggle parent tab
                    document.querySelectorAll('.structured-parent-tab').forEach(t => t.classList
                        .remove(
                            'active'));
            ...
            document.querySelectorAll('.structured-sub-tab').forEach(tab => {
                tab.addEventListener('click', () => {
                    ...
                    document.querySelectorAll(`.structured-sub-tab[data-parent="${parentId}"]`)
                        .forEach(
