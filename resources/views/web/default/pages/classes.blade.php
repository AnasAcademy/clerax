...
@section('content')
    <section class="site-top-banner search-top-banner  position-relative">
        <img src="{{asset('store/new/hero1.png')}}" width="" alt=""/>

        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white font-30 mb-15">{{ trans('product.the_courses') }}</h1>
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="/search" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    ...
                                    <button type="submit" class="btn new-btn rounded-pill px-4 py-10">{{ trans('home.find') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row mt-20">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="mt-20 p-20 rounded-sm shadow-lg border border-gray300 filters-container">
                            ...
                            <button type="submit" class="btn new-btn p-10 btn-block mt-30">{{ trans('site.filter_items') }}</button>
                        </div>
                    </div>
                </div>
